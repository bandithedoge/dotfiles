...
(let [base16 {:base00 ["Default Background" "Example: #282c34"]
              :base01 ["Lighter Background (Used for status bars, line number and folding marks)"
                       "Example: #3f4451"]
              :base02 ["Selection Background" "Example: #4f5666"]
              ...
              :base05 ["Default Foreground, Caret, Delimiters, Operators"
                       "Example: #abb2bf"]
              :base06 ["Light Foreground (Not often used)" "Example: #e6e6e6"]
              :base07 ["Light Background (Not often used)" "Example: #ffffff"]
              ...
              :base0F ["Deprecated, Opening/Closing Embedded Language Tags, e.g. <?php>"
                       "Example: #bf4034"]
              :base10 ["Darker Background" "Example: #21252b"]
              :base11 ["Darkest Background" "Example: #181a1f"]
