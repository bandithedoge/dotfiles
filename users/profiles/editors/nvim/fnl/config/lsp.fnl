...
[(_G.use :neovim/nvim-lspconfig
         {:event [:BufReadPre :BufNewFile]
          :dependencies [(when (not _G.USING_NIX) (_G.use "williamboman/mason.nvim"))
                         (_G.use :folke/neodev.nvim nil :/lua-dev.nvim)
          ...
          :config #(let [lsp (require :lspconfig)]
                     ...
                     (let [haskell-tools (require :haskell-tools)]
                       (haskell-tools.setup {:tools {:hover {:disable true}}
                     ...
                     (lsp.zls.setup $2))})
 ;;
 (_G.use :jose-elias-alvarez/null-ls.nvim {:dependencies [(_G.use :jose-elias-alvarez/typescript.nvim)]
                                           :event [:BufReadPre :BufNewFile]
 ...
 (_G.use :j-hui/fidget.nvim {:dependencies [(_G.use :neovim/nvim-lspconfig)]
                             :opts {:text {:spinner :dots
                                           :done "󰄬"}}})
 ;;
 (_G.use :ray-x/lsp_signature.nvim {:dependencies [(_G.use :neovim/nvim-lspconfig)]
                                    :opts {:bind true
 ...
 ;;
 (_G.use :DNLHC/glance.nvim {:dependencies [(_G.use :neovim/nvim-lspconfig)]
