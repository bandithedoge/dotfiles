...
#+begin_src emacs-lisp
  ;; ;;;###autoload
  ;; (defun +tree-sitter ()
  ;;   (when (assoc major-mode tree-sitter-major-mode-language-alist)
  ;;     (turn-on-tree-sitter-mode)
  ;;     (tree-sitter-hl-mode)))
  ;;
  ;; ;; TODO: migrate everything, more automatic highlighting
  ;; (use-package tree-sitter
  ;;   :hook ((prog-mode text-mode) . +tree-sitter)
  ;;   :init
  ;;   (use-package tree-sitter-langs)
  ;;   :config
  ;;   (use-package tree-sitter-indent
  ;;     :hook (tree-sitter-mode . tree-sitter-indent-mode)))
